...
import lkj.unicron.object.STLObject;
...
public class STLView extends GLSurfaceView {
	...
	public STLView(Context context, Uri uri) {
		...
		// Data loading.
		stlObject = new STLObject(stlBytes, context);

		SharedPreferences colorConfig = context.getSharedPreferences("other_configs", Activity.MODE_PRIVATE);
	...
	public float[] getVerticies() {
		return null; //stlObject.getVerticies();
	}
	
	public  void setVerticiesNull() {
		//stlObject.setVerticiesNull();
	}
